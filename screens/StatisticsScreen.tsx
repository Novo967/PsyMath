...
export default function StatisticsScreen() {
  ...
  const onShare = async () => {
    try {
      // ברגע שלוחצים שתף עכשיו, אפשר גם לסגור את התפריט אם רוצים
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {/* אזור פעולות שיתוף */}
        {!isShareMenuOpen ? (
          <TouchableOpacity style={styles.mainShareButton} onPress={() => setIsShareMenuOpen(true)}>
          ...
          <View style={styles.editPanel}>
            <View style={styles.editPanelHeader}>
              <TouchableOpacity onPress={() => setIsShareMenuOpen(false)} style={styles.closeMenuButton}>
                <Ionicons name="close-circle-outline" size={26} color="#A0AEC0" />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // סטיילים חדשים לכפתור השיתוף הראשי
  mainShareButton: {
  ...
  mainShareButtonText: {
    marginRight: 10, // מרווח בין האייקון לטקסט
    color: '#FFFFFF',
    fontWeight: '700',
    fontSize: 18,
  },
  ...
  shareButton: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#48BB78', // שיניתי לירוק כדי לתת תחושת "סיום פעולה"
    paddingVertical: 14,
    borderRadius: 12,
    marginTop: 10,
  },
